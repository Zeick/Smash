...
g2SM = -b2*g20^2/(16*pi^2) ...
    - b(1,1)*g10^2*g20^3/(16*pi^2)^2 ...
    - b(2,1)*g20^2*g20^3/(16*pi^2)^2 ...
    - b(3,1)*g30^2*g20^3/(16*pi^2)^2 ...
    - g20^3/(16*pi^2)^2*(C(2,1)*yu0^2 + C(2,2)*yd0^2 + C(2,3)*ye0);
g3SM = -b1*g30^2/(16*pi^2) ...
    - b(1,1)*g10^2*g30^3/(16*pi^2)^2 ...
    - b(2,1)*g20^2*g30^3/(16*pi^2)^2 ...
    - b(3,1)*g30^2*g30^3/(16*pi^2)^2 ...
