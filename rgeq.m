...
betal2 = -78*lh0^3 + 18*(3/5*g10^2 + 3*g20^2)*lh0^2 ...
    ...
    + 3/5*g10^2*((-57/10*g10^2 + 21*g20^2)*yu0^ + (3/2*g10^2 + 9*g20^2)*yd0^2 ...
    + (-15/2*g10^2 + 11*g20^2)*ye0^2) - 24*lh0^2*y2 -lh0*h + 6*lh0*yu0^2*yd0^2 ...
    + 20*(3*yu0^ + 3*yd0^6 + ye0^6) - 12*(yu0^2*(yu0^2 + yd0^2)*yd0^2);
...
betah2 = (5/3)^2*g10^4*(ng/2 + 471/800) + g20^4*(5/2*ng - 385/32) + 36/5*(5/3)*g10^2*lh0/2 + 36*g20^2*lh0/2 ...
    ...
    + 5/8*(5/3)*g10^2*yd0^2 + 15/8*(5/3)*g10^2*ye0^2 + 45/8*g20^2*yu0^2 - 9/4*ye0^2 + 45/8*g20^2*yd0^2 ...
...
g3 = g3SM + g30^3/(24*pi^2) ...
    + 1/(16*pi^2)^2*(38*g30^5/3 - g30^3*yq0^2 + 6/5*g10^2*g30^2*q^2);
% Top Yukawa
...
ye = yeSM + 1/(16*pi^2)*(ye0*yf0^2 - 3*yf0^2*ye0/2) ...
    ...
    + 15*yf0^2*ye0*yu0^2/4 + 5*yf0^2*ye0^2*yf0^2/4 + 5*yf0^2*ye0*ye0^2/4 ...
    + 11*yf0^4*ye0/4 - yf0^2*ye0^3 - 9*ye0^3*yf0^2/4 - ye0^2*yf0^2*ye0/4 ...
    + 7*yf0*yn0^2*yf0*ye0/8 - 3*ye0*yn0^2*yf0^2 + 99/25*ye0*g10^4*q^2);
...
% SM Higgs quadratic coupling (not yet here)
%mh = mhSM + 1/(16*pi^2)*(4*lhs0*ms0 + 2*yf0^2*mh0) ...
...
ls = 1/(16*pi^2)*(8*lhs0^2 + 20*ls0^2 - 6*yq0^2 + 12*yq0^2*ls0 + 2*yn0^2*ls0 - yn0^4) ...
    ...
    + 4*yf0^2*yn0^4 + ls0*(yn0^4 - 6*yn0^2*yf0^2) + 4*yn0^6 - 20*yn0^2*ls0^2);
...
% Quadratic singlet scalar coupling (not yet here)
...
%    - 48*yq0^2*ls0) + 18*g10^2*q^2*yq0^2*ms0^2 - mh0^2*lhs0*(16*ye0^2 ...
%    + 16*yf0^2) - ms0*(3/2*yn0^4 + 4*yn0^2*yf0^2 + 8*yn0^2*ls0));
